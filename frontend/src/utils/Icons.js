...
export const ruppee = <i className="fa-solid fa-indian-rupee-sign fa-sm"></i>;
...
export const fees = <i className="fa-solid fa-school"></i>;
export const copyright = <i className="fa-solid fa-copyright"></i>;
